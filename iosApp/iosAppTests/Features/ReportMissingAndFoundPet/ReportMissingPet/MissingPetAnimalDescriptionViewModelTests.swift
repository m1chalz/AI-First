...
@MainActor
final class MissingPetAnimalDescriptionViewModelTests: XCTestCase {
    ...
    private var viewModel: MissingPetAnimalDescriptionViewModel!
    ...
    override func setUp() async throws {
        ...
        viewModel = MissingPetAnimalDescriptionViewModel(
            flowState: flowState,
    ...
    func testInit_whenFlowStateHasData_shouldLoadExistingData() async {
        ...
        let vm = MissingPetAnimalDescriptionViewModel(
            flowState: flowState,
            locationHandler: locationHandler,
            toastScheduler: ToastSchedulerFake()
        )
