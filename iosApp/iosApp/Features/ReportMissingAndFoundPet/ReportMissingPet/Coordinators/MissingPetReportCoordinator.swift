...
class MissingPetReportCoordinator: CoordinatorInterface {
    ...
    private func navigateToChipNumber() {
        ...
        let viewModel = MissingPetChipNumberViewModel(flowState: flowState)
        ...
        let view = MissingPetChipNumberView(viewModel: viewModel)
    ...
    private func navigateToPhoto() {
        ...
        let view = MissingPetPhotoView(viewModel: viewModel)
        let hostingController = UIHostingController(
            rootView: NavigationBackHiding { view }
        )
    ...
    private func navigateToDescription() {
        ...
        let viewModel = MissingPetAnimalDescriptionViewModel(
            flowState: flowState,
        ...
        let view = MissingPetAnimalDescriptionView(viewModel: viewModel)
        let hostingController = UIHostingController(
            rootView: NavigationBackHiding { view }
        )
    ...
    private func navigateToContactDetails() {
        ...
        let viewModel = MissingPetContactDetailsViewModel(
        ...
        let view = MissingPetContactDetailsView(viewModel: viewModel)
        let hostingController = UIHostingController(
            rootView: NavigationBackHiding { view }
        )
    ...
    private func navigateToSummary(managementPassword: String) {
        ...
        let toastScheduler = ToastScheduler()
        let viewModel = MissingPetSummaryViewModel(flowState: flowState, toastScheduler: toastScheduler)

        viewModel.onClose = { [weak self] in
            self?.exitFlow()
        }
        
        let view = MissingPetSummaryView(viewModel: viewModel)
        let hostingController = UIHostingController(
            rootView: NavigationBackHiding { view }
        )
    ...
    deinit {
        print("deinit MissingPetReportCoordinator")
    }
}

// MARK: - Private Helpers

private extension MissingPetReportCoordinator {
