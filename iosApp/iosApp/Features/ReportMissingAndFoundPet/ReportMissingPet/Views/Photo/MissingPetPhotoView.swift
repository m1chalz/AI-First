...
struct MissingPetPhotoView: View {
    @ObservedObject var viewModel: MissingPetPhotoViewModel
...
#if DEBUG
struct MissingPetPhotoView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        return NavigationView {
            MissingPetPhotoView(viewModel: viewModel)
        }
    }
}
#endif
