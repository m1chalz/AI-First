...
@MainActor
class MissingPetContactDetailsViewModel: ObservableObject {
    ...
    init(submissionService: AnnouncementSubmissionServiceProtocol, flowState: MissingPetReportFlowState) {
    ...
    deinit {
        print("deinit MissingPetContactDetailsViewModel")
    }
}
