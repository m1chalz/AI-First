...
struct FoundPetChipNumberView: View {
    @ObservedObject var viewModel: FoundPetChipNumberViewModel
    ...
    private var inputField: some View {
        VStack(alignment: .leading, spacing: Layout.fieldLabelSpacing) {
            ...
            TextField("", text: $viewModel.chipNumber, prompt: Text(L10n.MicrochipNumber.fieldPlaceholder))
                ...
                .accessibilityIdentifier("foundPet.microchip.input")
    ...
    private var continueButton: some View {
        ...
        .accessibilityIdentifier("foundPet.microchip.continueButton")
    }
}
