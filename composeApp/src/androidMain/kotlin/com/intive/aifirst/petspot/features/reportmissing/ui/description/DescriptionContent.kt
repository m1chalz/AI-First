...
/**
 * Stateless content composable for Description screen (Step 3/4).
    ...
    Column(
        modifier =
            modifier
                .fillMaxSize()
                .statusBarsPadding()
                .testTag("reportMissing.description.content"),
    ) {
        ...
        Column(
            ...
            Text(
                text = "Fill out the details about the missing animal.",
            ...
            // Placeholder for description form (future implementation)
            Text(
                text = "Description Screen",
                style = MaterialTheme.typography.bodySmall,
                color = Color(0xFF9CA3AF),
                modifier = Modifier.testTag("reportMissing.description.placeholder"),
            )
        }
        ...
        Button(
            ...
            modifier =
                Modifier
                    ...
                    .padding(16.dp)
                    .testTag("description.continueButton"),
...
@Preview(name = "Description Content", showBackground = true)
@PreviewScreenSizes
@Composable
private fun DescriptionContentPreview() {
    MaterialTheme {
        DescriptionContent(state = ReportMissingUiState(currentStep = FlowStep.DESCRIPTION))
    }
}
