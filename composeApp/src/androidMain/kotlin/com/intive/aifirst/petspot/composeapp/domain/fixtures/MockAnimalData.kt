        ...
        val allAnimals =
            listOf(
                Animal(
                    ...
                    location = Location(latitude = 52.1711, longitude = 20.8128),
                    species = "Cat",
                    breed = "Maine Coon",
                ...
                Animal(
                    ...
                    name = "Bella",
                    photoUrl = "placeholder_cat",
                    location = Location(latitude = 50.0647, longitude = 19.9450),
                    species = "Cat",
                    breed = "Siamese",
                    gender = AnimalGender.FEMALE,
                ...
                Animal(
                    ...
                    name = "Buddy",
                    photoUrl = "placeholder_dog",
                    location = Location(latitude = 51.1079, longitude = 17.0385),
                    species = "Dog",
                ...
                Animal(
                    ...
                    location = Location(latitude = 54.3520, longitude = 18.6466),
                    species = "Bird",
                    breed = "Cockatiel",
                ...
                Animal(
                    ...
                    name = "Snowball",
                    photoUrl = "placeholder_cat",
                    location = Location(latitude = 52.4064, longitude = 16.9252),
                    species = "Cat",
                    breed = "Persian",
                    gender = AnimalGender.FEMALE,
                    status = AnimalStatus.MISSING,
                ...
                Animal(
                    ...
                    name = "Snoopy",
                    photoUrl = "placeholder_dog",
                    location = Location(latitude = 51.7592, longitude = 19.4560),
                    species = "Dog",
                    breed = "Beagle",
                    gender = AnimalGender.MALE,
                    status = AnimalStatus.FOUND,
                ...
                Animal(
                    ...
                    location = Location(latitude = 50.2649, longitude = 19.0238),
                    species = "Rabbit",
                    breed = "Dwarf Rabbit",
                    gender = AnimalGender.FEMALE,
                ...
                Animal(
                    ...
                    name = "Shadow",
                    photoUrl = "placeholder_dog",
                    location = Location(latitude = 53.4285, longitude = 14.5528),
                    species = "Dog",
                    breed = "Husky",
                    gender = AnimalGender.MALE,
                    status = AnimalStatus.MISSING,
                ...
                Animal(
                    ...
                    name = "Whiskers",
                    photoUrl = "placeholder_cat",
                    location = Location(latitude = 53.1325, longitude = 23.1688),
                    species = "Cat",
                ...
                Animal(
                    ...
                    name = "Luna",
                    photoUrl = "placeholder_dog",
                    location = Location(latitude = 51.2465, longitude = 22.5684),
                    species = "Dog",
                ...
                Animal(
                    ...
                    name = "Charlie",
                    photoUrl = "placeholder_cat",
                    location = Location(latitude = 50.0412, longitude = 21.9991),
                    species = "Cat",
                    breed = "Ragdoll",
                    gender = AnimalGender.MALE,
                    status = AnimalStatus.FOUND,
                ...
                Animal(
                    ...
                    name = "Max",
                    photoUrl = "placeholder_dog",
                    location = Location(latitude = 53.0138, longitude = 18.5984),
                    species = "Dog",
                    breed = "Dachshund",
                    gender = AnimalGender.MALE,
                    status = AnimalStatus.MISSING,
                ...
                Animal(
                    ...
                    name = "Milo",
                    photoUrl = "placeholder_bird",
                    location = Location(latitude = 50.2945, longitude = 18.6714),
                    species = "Bird",
                    breed = "Parrot",
                    gender = AnimalGender.UNKNOWN,
                    status = AnimalStatus.MISSING,
                ...
                Animal(
                    ...
                    name = "Daisy",
                    photoUrl = "placeholder_cat",
                    location = Location(latitude = 53.1235, longitude = 18.0084),
                    species = "Cat",
                    breed = "Bengal",
                    gender = AnimalGender.FEMALE,
                    status = AnimalStatus.MISSING,
                ...
                Animal(
                    ...
                    name = "Rocky",
                    photoUrl = "placeholder_dog",
                    location = Location(latitude = 53.7784, longitude = 20.4801),
                    species = "Dog",
                    breed = "Rottweiler",
                    gender = AnimalGender.MALE,
                    status = AnimalStatus.MISSING,
