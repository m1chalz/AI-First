...
class PetSpotApplication : Application() {
    ...
    override fun onCreate() {
        ...
        startKoin {
            ...
            modules(
                domainModule,      // Shared domain dependencies (use cases, business logic)
                dataModule,        // Android data layer (repositories, APIs, databases)
                viewModelModule    // Android ViewModels for UI
            )
        }
    }
}
