...
class SummaryViewModelTest {
    ...
    @Test
    fun `should initialize with password from flowState`() =
        runTest {
            // Given
    ...
    @Test
    fun `should initialize with empty string when flowState password is null`() =
        runTest {
    ...
    @Test
    fun `should preserve initial state values`() =
        runTest {
            // Given
    ...
    @Test
    fun `should initialize with 7-digit password from flowState`() =
        runTest {
    ...
    @Test
    fun `should initialize with 6-digit password from flowState`() =
        runTest {
    ...
    @Test
    fun `CopyPasswordClicked should not crash with null clipboardManager`() =
        runTest {
            // Given
    ...
    @Test
    fun `state should remain unchanged after CopyPasswordClicked`() =
        runTest {
            // Given
            val password = "5216577"
            flowState.updateManagementPassword(password)
    ...
    @Test
    fun `CloseClicked should emit DismissFlow effect`() =
        runTest {
            // Given
            viewModel = createViewModel()
            testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun `CloseClicked should emit DismissFlow regardless of password state`() =
        runTest {
            // Given - password set
            flowState.updateManagementPassword("5216577")
            viewModel = createViewModel()
    ...
    @Test
    fun `CloseClicked should emit DismissFlow when password is empty`() =
        runTest {
    ...
    @Test
    fun `should handle multiple CopyPasswordClicked intents without crash`() =
        runTest {
            // Given
            flowState.updateManagementPassword("5216577")
            viewModel = createViewModel()
    ...
    @Test
    fun `should emit DismissFlow after copy and close sequence`() =
        runTest {
            // Given
            flowState.updateManagementPassword("5216577")
            viewModel = createViewModel()
    ...
    @Test
    fun `password in state should match exactly what was set in flowState`() =
        runTest {
            // Given
