...
class PetDetailsViewModelTest {
    ...
    @Test
    fun `LoadPet should emit loading then success state`() = runTest {
        // Given
    ...
    @Test
    fun `LoadPet should emit loading then error state on failure`() = runTest {
        // Given
    ...
    @Test
    fun `NavigateBack should emit NavigateBack effect`() = runTest {
        // Given
    ...
    @Test
    fun `ShowOnMap should emit ShowMap effect when location has coordinates`() = runTest {
        // Given
        val pet = MockAnimalData.generateMockAnimals().first()
        fakeRepository.result = pet
    ...
    @Test
    fun `RetryLoad should reload pet with stored ID`() = runTest {
        // Given
        val pet = MockAnimalData.generateMockAnimals().first()
        fakeRepository.result = pet
