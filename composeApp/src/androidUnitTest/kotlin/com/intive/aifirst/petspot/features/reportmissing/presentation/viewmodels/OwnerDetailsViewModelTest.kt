...
class OwnerDetailsViewModelTest {
    ...
    @Test
    fun `UpdatePhone should update state and clear error`() =
        runTest {
            // Given
    ...
    @Test
    fun `UpdatePhone should sync with flow state`() =
        runTest {
            // Given
            val phone = "+48123456789"
    ...
    @Test
    fun `UpdateEmail should update state and clear error`() =
        runTest {
            // Given
    ...
    @Test
    fun `UpdateEmail should sync with flow state`() =
        runTest {
            // Given
            val email = "owner@example.com"
    ...
    @Test
    fun `UpdateReward should update state`() =
        runTest {
            // Given
    ...
    @Test
    fun `UpdateReward should truncate at 120 characters`() =
        runTest {
            // Given
    ...
    @Test
    fun `UpdateReward should sync with flow state`() =
        runTest {
            // Given
            val reward = "$250 gift card"
    ...
    @Test
    fun `ContinueClicked with too few digits should set phoneError`() =
        runTest {
            // Given
    ...
    @Test
    fun `ContinueClicked with too many digits should set phoneError`() =
        runTest {
            // Given
    ...
    @Test
    fun `ContinueClicked with invalid email should set emailError`() =
        runTest {
            // Given
    ...
    @Test
    fun `ContinueClicked with both invalid should set both errors`() =
        runTest {
            // Given
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdatePhone("123"))
    ...
    @Test
    fun `ContinueClicked with valid inputs should not set errors`() =
        runTest {
            // Given
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdatePhone("+48123456789"))
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdateEmail("owner@example.com"))
    ...
    @Test
    fun `ContinueClicked with invalid inputs should emit ShowSnackbar effect`() =
        runTest {
            // Given
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdatePhone("123"))
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdateEmail("owner@example.com"))
    ...
    @Test
    fun `BackClicked should emit NavigateBack effect`() =
        runTest {
            // When/Then
            viewModel.effects.test {
    ...
    @Test
    fun `ViewModel should initialize from flow state`() =
        runTest {
            // Given
    ...
    @Test
    fun `ContinueClicked with valid inputs should set isSubmitting true`() =
        runTest {
            // Given
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdatePhone("+48123456789"))
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdateEmail("owner@example.com"))
    ...
    @Test
    fun `ContinueClicked with valid inputs should emit NavigateToSummary on success`() =
        runTest {
            // Given
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdatePhone("+48123456789"))
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdateEmail("owner@example.com"))
    ...
    @Test
    fun `ContinueClicked should set isSubmitting false after success`() =
        runTest {
            // Given
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdatePhone("+48123456789"))
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdateEmail("owner@example.com"))
    ...
    @Test
    fun `ContinueClicked should emit ShowSnackbar with Retry on failure`() =
        runTest {
            // Given
            ...
            viewModel.effects.test {
                ...
                assertEquals(
                    ...
                    (effect as OwnerDetailsUiEffect.ShowSnackbar).message,
                )
    ...
    @Test
    fun `ContinueClicked should set isSubmitting false after failure`() =
        runTest {
            // Given
            fakeRepository.createAnnouncementResult = Result.failure(Exception("Network error"))
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdatePhone("+48123456789"))
    ...
    @Test
    fun `RetryClicked should trigger submission again`() =
        runTest {
    ...
    @Test
    fun `ContinueClicked should not double-submit when already submitting`() =
        runTest {
            // Given
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdatePhone("+48123456789"))
            viewModel.dispatchIntent(OwnerDetailsUserIntent.UpdateEmail("owner@example.com"))
