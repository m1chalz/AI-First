...
class SubmitAnnouncementUseCaseTest {
    ...
    @Test
    fun `invoke should return success with managementPassword when both steps succeed`() =
        runTest {
            // Given
            val flowData = createValidFlowData()
            repository.createAnnouncementResult =
                Result.success(
    ...
    @Test
    fun `invoke should pass correct data to createAnnouncement`() =
        runTest {
            // Given
            val flowData = createValidFlowData()
    ...
    @Test
    fun `invoke should pass correct data to uploadPhoto`() =
        runTest {
            // Given
            val flowData = createValidFlowData()
            repository.createAnnouncementResult =
    ...
    @Test
    fun `invoke should skip photo upload when photoUri is null`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should return failure when createAnnouncement fails`() =
        runTest {
            // Given
            val flowData = createValidFlowData()
    ...
    @Test
    fun `invoke should return failure when uploadPhoto fails`() =
        runTest {
            // Given
            val flowData = createValidFlowData()
    ...
    @Test
    fun `invoke should handle optional fields correctly`() =
        runTest {
            // Given
            val flowData =
                createValidFlowData().copy(
                    chipNumber = "",
    ...
    @Test
    fun `invoke should include optional fields when provided`() =
        runTest {
            // Given
            val flowData =
                createValidFlowData().copy(
    ...
    private fun createValidFlowData(): FlowData =
        FlowData(
            // Step 1
            chipNumber = "123456789012345",
            // Step 2
