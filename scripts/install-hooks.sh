...
if [ -x "$HOOK_DEST" ]; then
    ...
    echo "  - Checkstyle (Java code style, for e2e-tests/java/)"
    echo "  - SpotBugs (Java bug detection, for e2e-tests/java/)"
    echo "  - gherkin-lint (Gherkin feature files validation)"
    echo ""
