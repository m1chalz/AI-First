...
describe('PetDetailsModal', () => {
  ...
  it('should not render when modal is closed', () => {
    ...
    const { container } = render(<PetDetailsModal isOpen={false} selectedPetId={null} onClose={mockOnClose} />);
  ...
  it('should render modal when opened', () => {
    ...
    const { baseElement } = render(<PetDetailsModal isOpen={true} selectedPetId="pet-123" onClose={mockOnClose} />);
  ...
  it('should call onClose when close button is clicked', async () => {
    ...
    render(<PetDetailsModal isOpen={true} selectedPetId="pet-123" onClose={mockOnClose} />);
