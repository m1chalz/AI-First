...
export const AnimalCard: React.FC<AnimalCardProps> = ({ animal, onDetailsClick }) => {
  ...
  return (
    <div className={styles.animalCard} data-testid={`animalList.item.${animal.id}`}>
      ...
      <div className={styles.animalBasicInfo}>
        ...
        <div className={styles.speciesRow}>
          ...
          {animal.sex !== 'UNKNOWN' && <span className={styles.genderIcon}>{getGenderIcon(animal.sex)}</span>}
        </div>
      </div>
      ...
      <div className={styles.animalStatusSection}>
        <div className={styles.statusDateGroup}>
          ...
          <div className={styles.animalDate}>{animal.lastSeenDate}</div>
        </div>
