  ...
  return (
    <NewAnnouncementLayout title="Owner's details" progress="4/4" onBack={handleBack}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', width: '100%' }}>
        ...
        <p className={styles.description}>Add your contact information and potential reward.</p>
        ...
        >
          <div className={styles.inputGroup}>
            ...
            />
            {phoneError && <div style={{ color: '#FB2C36', fontSize: '14px', marginTop: '4px' }}>{phoneError}</div>}
          </div>
          ...
          <div className={styles.inputGroup}>
            ...
            />
            {emailError && <div style={{ color: '#FB2C36', fontSize: '14px', marginTop: '4px' }}>{emailError}</div>}
          </div>
