...
describe('GenderSelector', () => {
  ...
  it('should render Male and Female options', () => {
    render(<SexSelector value="" onChange={mockOnChange} />);

    expect(screen.getByText('Male')).toBeDefined();
    expect(screen.getByText('Female')).toBeDefined();
  });

  it.each(['Male', 'Female'])('should display %s as capitalized label', (label) => {
    render(<SexSelector value="" onChange={mockOnChange} />);
  ...
  it('should show Male as checked when value is MALE', () => {
    render(<SexSelector value="MALE" onChange={mockOnChange} />);
  ...
  it('should show Female as checked when value is FEMALE', () => {
    render(<SexSelector value="FEMALE" onChange={mockOnChange} />);
  ...
  it('should have mutually exclusive selection', () => {
    const { rerender } = render(<SexSelector value="MALE" onChange={mockOnChange} />);
    ...
    rerender(<SexSelector value="FEMALE" onChange={mockOnChange} />);
  ...
  it('should display error message when provided', () => {
    ...
    render(<SexSelector value="" onChange={mockOnChange} error={errorMessage} />);
  ...
  it('should include data-testid attribute', () => {
    ...
    render(<SexSelector value="" onChange={mockOnChange} testId={testId} />);
