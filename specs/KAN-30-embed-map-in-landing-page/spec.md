...
- **FR-002**: The map preview MUST be a static, non-interactive image displaying standard map features (streets, landmarks, terrain)
...
- A suitable map rendering service or library is available for generating static map previews
