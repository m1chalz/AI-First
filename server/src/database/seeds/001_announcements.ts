...
const ANNOUNCEMENTS = [
  ...
  },
  {
    ...
    sex: 'UNKNOWN',
    age: null,
    description: 'Żółta papużka, bardzo gadatliwa. Zna zwroty "cześć" i "piękny ptaszek". Widziana w okolicy Tarnogaja we Wrocławiu.',
    microchip_number: null,
    location_latitude: 51.08,
    location_longitude: 16.98,
  ...
  },
  {
    ...
    sex: 'MALE',
    age: 5,
    description: 'Brązowy kundelek, średniej wielkości. Nosi niebieską obrożę z identyfikatorem. Widoczny koło Rynku we Wrocławiu.',
    microchip_number: '987654321098765',
    location_latitude: 51.1079,
    location_longitude: 17.0328,
  ...
  },
  {
    ...
    sex: 'MALE',
    age: 2,
    description: 'Kremowy kot syjamski z niebieskimi oczami. Bardzo głośny. Ostatnio widziano w Popowicach we Wrocławiu.',
    microchip_number: null,
    location_latitude: 51.13,
    location_longitude: 17.02,
  ...
  },
  {
    ...
    sex: 'FEMALE',
    age: 1,
    description: 'Mały biały królik z opadającymi uszami. Bardzo łagodny i przyjazny. Zaginął w Szczecinie.',
    microchip_number: null,
    location_latitude: 53.43,
    location_longitude: 14.55,
  ...
  },
  {
    ...
    sex: 'MALE',
    age: 8,
    description: 'Mały kundelek, płowy. Bez obroży. Lekko kuleie na lewą przednią łapę. Widziano w Szczecinie.',
    microchip_number: null,
    location_latitude: 53.44,
    location_longitude: 14.54,
    last_seen_date: '2025-11-05',
    email: 'schronisko@example.pl',
    phone: '555-PETS',
    photo_url: '/images/seed-77777777-7777-7777-7777-777777777777.jpg',
    status: 'FOUND',
    reward: null,
  ...
  },
  {
    ...
    sex: 'MALE',
    age: null,
    description: 'Ciemnobrązowa fretka, bardzo zabawna. Nosi małą obrożę z dzwoneczkiem. Zaginęła w Szczecinie.',
    microchip_number: null,
    location_latitude: 53.42,
    location_longitude: 14.56,
    last_seen_date: '2025-11-14',
    email: 'wlasciciel.fretki@example.pl',
    phone: '+48-312-555-0142',
    photo_url: '/images/seed-88888888-8888-8888-8888-888888888888.jpeg',
    status: 'MISSING',
    reward: null,
