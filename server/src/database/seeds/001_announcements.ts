...
const ANNOUNCEMENTS = [
  ...
  },
  {
    ...
    sex: 'UNKNOWN',
    age: null,
    description: 'Yellow budgie, very talkative. Knows phrases "hello" and "pretty bird". Last seen near Tarnogaj in Wrocław.',
    microchip_number: null,
  ...
  },
  {
    ...
    sex: 'MALE',
    age: 5,
    description: 'Brown mixed breed dog, medium-sized. Wears a blue collar with an ID tag. Spotted near the Town Square in Wrocław.',
  ...
  },
  {
    ...
    sex: 'MALE',
    age: 2,
    description: 'Cream-colored Siamese cat with blue eyes. Very vocal. Last seen in Popowice, Wrocław.',
    microchip_number: null,
  ...
  },
  {
    ...
    sex: 'FEMALE',
    age: 1,
    description: 'Small white rabbit with floppy ears. Very gentle and friendly. Went missing in Szczecin.',
    microchip_number: null,
  ...
  },
  {
    ...
    sex: 'MALE',
    age: 8,
    description: 'Small mixed breed dog, fawn-colored. No collar. Limps slightly on left front paw. Spotted in Szczecin.',
    microchip_number: null,
  ...
  },
  {
    ...
    sex: 'MALE',
    age: null,
    description: 'Dark brown ferret, very playful. Wears a small collar with a bell. Went missing in Szczecin.',
    microchip_number: null,
